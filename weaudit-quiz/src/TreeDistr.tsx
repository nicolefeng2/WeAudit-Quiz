...
interface TreeDistrProps {
    onSubmit: () => void;
}

function FlowerDistr({ onSubmit }: TreeDistrProps) {
  useEffect(() => {
  ...
  return (
    <div className="BiasDistribution-base">
      ...
      <div className="title-container">
        <div className="title-box">
          <p className="title-text">
            ...
            <span id="prompt-title">Trees</span>
          </p>
        </div>
      </div>
      ...
      <div className="distr-body-container">
        ...
        <div className="chart">
        <img src={tree_distr} className="chart-img" alt="tree-chart" />
        </div>
